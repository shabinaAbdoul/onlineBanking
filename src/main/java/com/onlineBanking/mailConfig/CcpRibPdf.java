...
public class CcpRibPdf {
	
		 
		 private UserDetails userDetails;
		    public CcpRibPdf( UserDetails userDetails) {
			super();
		    ...
		    private void writeTableData(PdfPTable table) {
		        ...
		        String Str = new String(userDetails.getCcpAccount().getNumIban());
		    ...
		    public void export(HttpServletResponse response) throws DocumentException, IOException {
		        ...
		        cell.setPhrase(new Phrase(userDetails.getCcpAccount().getNumIban(), fontM));
		        table1.addCell(cell);
